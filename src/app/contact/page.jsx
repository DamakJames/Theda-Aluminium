...
export default function ContactPage() {
  ...
  return (
    <main>
      <section className="hero-section" style={{ padding: '40px 0', minHeight: 'auto', backgroundImage: 'linear-gradient(135deg, rgba(10, 61, 145, 0.85) 0%, rgba(10, 61, 145, 0.7) 100%), url(https://images.unsplash.com/photo-1554469384-e58fac16e23a?auto=format&fit=crop&w=1920&q=80)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              ...
              <div style={{ display: 'grid', gap: '30px' }}>
                ...
                <div style={{ background: 'var(--gray-50)', padding: '30px', borderRadius: 'var(--radius-md)', borderLeft: '4px solid var(--primary-blue)' }}>
                  ...
                  <p style={{ color: 'var(--gray-600)', marginBottom: '5px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    Opposite Airforce Base, Mando, Kaduna State.
                  </p>
                </div>
